...
CREATE TABLE `appointment`  (
  ...
  `appl_time` datetime NULL DEFAULT NULL COMMENT '预约时间',
  `appl_info` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '信息',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1498530959870451714 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `diagnosis`  (
  ...
  `info` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '信息',
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '诊断类型',
  `status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '状态',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `doctor`  (
  `doctor_id` int NOT NULL AUTO_INCREMENT COMMENT '医生主键ID',
  `doctor_number` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编号',
  `doctor_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `doctor_photo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '照片',
  `doctor_post` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所属科室',
  `doctor_email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邮件',
  `doctor_phone` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电话',
  `doctor_age` int NULL DEFAULT NULL COMMENT '年龄',
  `doctor_gender` int NULL DEFAULT NULL COMMENT '性别',
  `doctor_level` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '职位',
  `doctor_demo1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '简介1',
  `doctor_demo2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '简介2',
  `doctor_demo3` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '简介3',
  PRIMARY KEY (`doctor_id`) USING BTREE,
  INDEX `doctor_name`(`doctor_name` ASC) USING BTREE,
  INDEX `doctor_number`(`doctor_number` ASC) USING BTREE
...
CREATE TABLE `message`  (
  ...
  `foreign_id` int NULL DEFAULT 0 COMMENT '关联id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `notice`  (
  ...
  `view_count` int NULL DEFAULT NULL COMMENT '查看次数',
...
CREATE TABLE `pet`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '宠物名',
  `weight` double NULL DEFAULT NULL COMMENT '体重',
  `height` double NULL DEFAULT NULL COMMENT '身长',
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '宠物所属类型',
  `create_time` datetime NULL DEFAULT NULL COMMENT '出生时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `standard`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `age_min` int NULL DEFAULT NULL COMMENT '开始年龄',
  `age_max` int NULL DEFAULT NULL COMMENT '结束年龄',
  ...
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '状态',
  `status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '类型',
  PRIMARY KEY (`id`) USING BTREE
